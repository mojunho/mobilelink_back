...
<!-- End Navbar -->
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('../../../resources/assets/img/login.jpg'); background-size: cover; background-position: top center;">
            ...
            <form class="form" method="POST" action="/login">
              ...
              <div class="card card-login card-hidden">
                ...
                <div class="card-footer justify-content-center">
                  <button type="submit" class="btn btn-rose btn-link btn-lg">로그인</button>
<%--                  <a href="#pablo" class="btn btn-rose btn-link btn-lg">로그인</a>--%>
                </div>
              </div>
            </form>
          </div>
