            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header card-header-icon card-header-rose">
                        ...
                        <h4 class="card-title">회원정보 -
                            <small class="category">프로필</small>
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="bmd-label-floating">통신사</label>
                                    <input type="text" class="form-control" disabled value="<c:out value="${memberTelecom}"/>">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="bmd-label-floating">이름</label>
                                    <input type="text" class="form-control" disabled value="<c:out value="${memberName}"/>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled value="<c:out value="${memberLogin}"/>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="bmd-label-floating">비밀번호</label>
                                    <input type="password" class="form-control" disabled value="<c:out value="${memberPassword}"/>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" disabled value="<c:out value="${memberPhNum}"/>">
                                </div>
                            </div>
                        </div>
<%--                        <button type="submit" class="btn btn-rose pull-right" href="/memberedit">회원정보 수정하기</button>--%>
                        <a href="/member/memberedit" class="btn btn-rose pull-right">수정하기</a>
