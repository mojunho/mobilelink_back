...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-icon card-header-rose">
                  ...
                  <h4 class="card-title">회원정보 수정 -
                    <small class="category">수정</small>
                  </h4>
                </div>
                <div class="card-body">
                  <%--@elvariable id="memberVo" type="kr.co.erst.mobilelink_back.vo.MemberVo"--%>
                  <form:form name="editmember" method="post" modelAttribute="memberVo">
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-group">
                          <c:if test="${empty memberTelecom}">
                          ...
                          <c:if test="${not empty memberTelecom}">
                            <select class="form-control" data-style="select-with-transition" title="통신사" data-size="3" name="telecom">
                              <option disabled>통신사</option>
                              <option value="1" <c:if test="${memberTelecom == 1}">selected</c:if>>SKT</option>
                              <option value="2" <c:if test="${memberTelecom == 2}">selected</c:if>>KT</option>
                              <option value="3" <c:if test="${memberTelecom == 3}">selected</c:if>>LGT</option>
                            </select>
                          </c:if>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <form:input type="text" class="form-control" path="name" name="name" readonly="true" cssStyle="background-color: white"/>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <form:input type="text" class="form-control" path="login" name="login" readonly="true" cssStyle="background-color: white"/>
                    ...
                    <button type="button" class="btn btn-rose pull-right" id="mbEditBtn">수정하기</button>
                    <button type="button" class="btn btn-rose pull-right" id="mbDeleteBtn">삭제하기</button>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#mbEditBtn').click(function () {
        if (confirm('수정하시겠습니까?')) {
          document.editmember.action = "/member/memberedit";
          document.editmember.submit();
        }
      });
      $('#mbDeleteBtn').click(function () {
        if (confirm('삭제하시겠습니까?')) {
          document.editmember.action = "/member/memberdelete";
          document.editmember.submit();
        }
      });
